...
namespace Modbus.ModbusFunctions
{
    ...
    public class WriteSingleCoilFunction : ModbusFunction
    {
        ...
        public override byte[] PackRequest()
        {
            ...
            WriteUInt16(request, 8, p.OutputAddress);
            WriteUInt16(request, 10, coilValue);
        ...
        public override Dictionary<Tuple<PointType, ushort>, ushort> ParseResponse(byte[] response)
        {
            ...
            ushort address = ReadUInt16(response, 8);
            ushort value = ReadUInt16(response, 10);
            retVal.Add(new Tuple<PointType, ushort>(PointType.DIGITAL_OUTPUT, address), (ushort)(value == 0xFF00 ? 1 : 0));
            return retVal;
        }
